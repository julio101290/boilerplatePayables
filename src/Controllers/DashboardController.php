...
class DashboardController extends BaseController {
    ...
    public function index() {
        ...
        $productos = $this->payables->mdlVentasPorProductosAgrupado(0
                , 0
                , 0
                , '1990-01-01'
                , '2048-01-01'
        ...
        return view('julio101290\boilerplatepayables\Views\dashboard', $data);
    }
    ...
    public function traerInfo($desdeFecha, $hastaFecha) {
         ...
         */
        $carteraVencida = $this->payables->mdlCarteraVencida($empresasID, $sucurssalesID);
        ...
        foreach ($carteraVencida as $key => $value) {
            ...
            $ruta = base_url("admin/listPayables/1990-01-01/2100-01-01/false/0/0/$value[id]");
