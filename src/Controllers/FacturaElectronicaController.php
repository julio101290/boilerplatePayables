...
class FacturaElectronicaController extends BaseController {
    ...
    public function __construct() {
        ...
        //$this->payablesDetails = new PayablesDetailsModel();
    ...
    public function timbrar($uuidVenta) {
        ...
        $venta = $this->payables->select("*")->where("UUID ", $uuidVenta)->first();
...
// VERIFICAMOS SI YA TIENE VENTA
        ...
        $creator->addPayableo($csd->privateKey()->pem(), $csd->privateKey()->passPhrase());
        $xml = $creator->asXml();
...
// VERIFICAMOS SI YA TIENE VENTA
        ...
        foreach ($ventasPagadas as $key => $value) {
            ...
            $venta = $this->payables->select("*")->where("id", $value["idPayable"])->first();
