...
<?= $this->include('julio101290\boilerplatepayables\Views/modulesNotasCredito/dataHeadNotasCredito') ?>
<?= $this->include('julio101290\boilerplatepayables\Views/modulesNotasCredito/moreInfoRow') ?>
<?= $this->include('julio101290\boilerplatepayables\Views\modulesNotasCredito/productosModalPayables') ?>
