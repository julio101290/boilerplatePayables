...
<?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/dataHeadPayables') ?>
<?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/productosModalPayables') ?>
<?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/modalPayment') ?>
<?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/moreInfoRow') ?>
