...
<div class="row">
    ...
    <div class="col-lg-2  col-xs-12 col-md-2">
        <div class="form-group">
            <label for="datetime"><?= lang('newPayable.date') ?></label>
            <input type="date" id="date" name="date" value="<?= $fecha ?>">
        </div>
    </div>
    <div class="col-4" col-lg-12>
        <div class="form-group">
            <label for="idEmpresaPayables"><?= lang('newPayable.companie') ?> </label>
            <select id='idEmpresaPayables' name='idEmpresaPayables' class="idEmpresaPayables" style='width: 80%;'>
                ...
                if (isset($idEmpresa)) {
                    ...
                    echo "  <option value=''>".lang('newPayable.selectCompanie')."</option>";
    ...
    <div class="col-lg-2  col-xs-12 col-md-2">
        <div class="form-group">
            <label for="idSucursal"><?= lang('newPayable.branchoffice') ?> </label>
    ...
    <div class="col-lg-4  col-xs-12 col-md-4 pull-right" style="
         ...
         ">
        <div class="form-group ">
            <label for="codePayable"><?= lang('newPayable.folio') ?></label>


            <input type="text" id="codePayable" name="codePayable" disabled value="<?= $folio ?>">
        </div>
    </div>
...
<div class="row comprobantesRD" hidden>
    ...
    <div class="col-6">
        <div class="form-group">
            <label for="tipoComprobanteRD"><?= lang('newPayable.typeVoucher') ?> </label>
            <select id='tipoComprobanteRD' name='tipoComprobanteRD' class="tipoComprobanteRD" style='width: 100%;'>
                ...
                if (isset($tipoComprobanteRDID)) {
                    ...
                    echo "  <option value=''>".lang('newPayable.selectTypeVoucher')."</option>";
                }
                ?>
    ...
    <div class="col-6 pull-right" style="text-align: right;">
        <div class="form-group ">
            <label for="folioComprobanteRD"><?= lang('newPayable.typeVoucher') ?></label>
...
<div class="row">
    ...
    <div class="col-lg-2  col-xs-12 col-md-2">
        <div class="form-group">
            <label for="custumerPayable"><?= lang('newPayable.custumer') ?> </label>
            <select id='custumerPayable' name='custumerPayable' class="custumerPayable" style='width: 100%;'>
                ...
                if (isset($idCustumer)) {
                    ...
                    echo "  <option value=''>".lang('newPayable.selectCustumer') ."</option>";
                }
                ?>
    ...
    <div class="col-lg-1  col-xs-12 col-md-1">
        <div class="form-group">
            <label for="datetime"><?= lang('newPayable.expirationDate') ?></label>
