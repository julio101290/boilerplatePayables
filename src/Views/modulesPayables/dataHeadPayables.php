...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><?= lang('newPayable.header') ?></h3>
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="generales-tab" data-toggle="tab" data-target="#generales" type="button" role="tab" aria-controls="generales" aria-selected="true"><?= lang('newPayable.generals') ?></button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="documentosRelacionados-tab" data-toggle="tab" data-target="#documentosRelacionados" type="button" role="tab" aria-controls="documentosRelacionados" aria-selected="false">
                            <?= lang('newPayable.relationDocuments') ?>
                        </button>
                    </li>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="generales" role="tabpanel" aria-labelledby="generales">
                        ...
                        <?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/generalPayables') ?>

                    </div>

                    <div class="tab-pane fade" id="otrosDatos" role="tabpanel" aria-labelledby="otrosDatos">

                        <?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/otrosDatos') ?>

                    </div>

                    <div class="tab-pane fade" id="datosExtraVehiculo" role="tabpanel" aria-labelledby="datosExtraVehiculo">

                        <?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/datosExtrasVehiculos') ?>
                    ...
                    <div class="tab-pane fade" id="facturaGlobal" role="tabpanel" aria-labelledby="facturaGlobal">
                        ...
                        <?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/facturaGlobal') ?>
                    ...
                    <div class="tab-pane fade" id="facturacionMX" role="tabpanel" aria-labelledby="otrosDatos">
                        ...
                        <?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/facturacionMX') ?>
                    ...
                    <div class="tab-pane fade" id="documentosRelacionados" role="tabpanel" aria-labelledby="documentosRelacionados">
                        ...
                        <?= $this->include('julio101290\boilerplatepayables\Views\modulesPayables/documentosRelacionados') ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title"><?= lang('newPayable.payableDetail') ?></h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="box" style="overflow-y: scroll; height:250px;">
                                    ...
                                    ENCABEZADO
                                    ======================================-->
                                        <div class="col-1"> <?= lang('newPayable.fields.row') ?> </div>
                                        <div class="d-none d-lg-table-cell col-1 "> <?= lang('newPayable.fields.code') ?> </div>
                                        <div class="col-7"> <?= lang('newPayable.fields.description') ?> </div>
                                        <div class="col-1"><?= lang('newPayable.fields.amount') ?> </div>
                                        <div class="col-1"><?= lang('newPayable.fields.price') ?> </div>
                                        <div class="col-1"><?= lang('newPayable.fields.total') ?> </div>
                            ...
                            <div class="box-footer" style="
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-3" style="
                                         ...
                                         ">
                                        <label style="vertical-align: sub;margin-bottom: 0px;"><?= lang('newPayable.subTotal') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group grupoTotalRetencionIVA" hidden>
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newPayable.VATWithholding') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group grupoTotalTasaExcenta" hidden>
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newPayable.exemptRate') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group grupoTotalRetencionISR" hidden>
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newPayable.ISRWithholding') ?>:</label>
                                    </div>
                                ...
                                <button type="button" class="btn btn-primary pull-right btnSavePayables" data-toggle="modal">
                                    <i class="fa far fa-save"> </i><?= lang('newPayable.save') ?></button>
    ...
    <script>
        ...
        $("#idEmpresaPayables").on("change", function () {
            ...
            $.ajax({
                ...
                url: "<?= base_url('admin/payables/getLastCode') ?>",
                method: "POST",
                data: datos,
                cache: false,
                contentType: false,
                ...
                success: function (respuesta) {
                    ...
                    $("#codePayable").val(respuesta["folio"]);
        ...
        $("#idSucursal").on("change", function () {
            ...
            var idEmpresa = $("#idEmpresaPayables").val();
        ...
        $(document).on('click', '#btnSaveChoferes', function (e) {
            ...
            if (idEmpresa == 0 || idEmpresa == null) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newPayable.selectCompanie') ?>"
                });
                return;
            }
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    if (respuesta.match(/Correctamente.*/)) {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: "<?= lang('newPayable.driverSavedSucess') ?>"
                        });
            ...
            $("#idSucursal").select2({
                ajax: {
                    ...
                    data: function (params) {
                        ...
                        var idEmpresa = $('.idEmpresaPayables').val(); // CSRF hash
        ...
        $("#custumerPayable").on("change", function () {
        ...
        $("#idVehiculoPayable").on("change", function () {
        ...
        $(document).on('click', '#btnSaveVehiculos', function (e) {
            ...
            if (idTipoVehiculo == 0 || idTipoVehiculo == null) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newPayable.vehiclesNeedSelected') ?>"
                });
                return;
            }
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    if (respuesta.match(/Correctamente.*/)) {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: "<?= lang('newPayable.vehiclesSavedSucess') ?>"
                        });
        ...
        $(".btnSavePayables").on("click", function () {
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    ...
                    if (respuesta.match(/success.*/)) {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: "<?= lang('newPayable.stampSuccess') ?>"
                        });
        ...
        function savePayable() {
            ...
            var idEmpresa = $("#idEmpresaPayables").val();
            var custumerPayable = $("#custumerPayable").val();
            var date = $("#date").val();
            ...
            var idVehiculo = $("#idVehiculoPayable").val();
            var idChofer = $("#idChoferPayable").val();
            ...
            if (custumerPayable == 0 || custumerPayable == "") {

                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newPayable.selectCustumer') ?>"
                });
            ...
            if (idSucursal == 0 || idSucursal == "") {
                ...
                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newPayable.selectBranchoffice') ?>"
                });
            ...
            $(".btnSavePayables").attr("disabled", true);


            var datos = new FormData();
            datos.append("idCustumer", custumerPayable);
            datos.append("idEmpresa", idEmpresa);
            ...
            $.ajax({
                ...
                url: "<?= base_url('admin/payables/save') ?>",
                method: "POST",
                data: datos,
                cache: false,
                contentType: false,
                ...
                success: function (respuesta) {
                    ...
                    if (respuesta.match(/Correctamente.*/)) {
                        ...
                        $(".btnSavePayables").removeAttr("disabled");
        ...
        $(".btnPrint").on("click", function () {
            ...
            if (saved == true) {
                ...
                window.location = "<?= base_url('admin/payables') ?>";
        ...
        function cargaProductos() {
            ...
            var empresa = $("#idEmpresaPayables").val();
