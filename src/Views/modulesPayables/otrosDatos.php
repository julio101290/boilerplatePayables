<p>
<h3><?= lang('newPayable.others') ?></h3>
<div class="row">


    <div class="col-6">
        <div class="form-group">
            <label for="quoteTo"><?= lang('newPayable.quoteTo') ?>: </label>
    ...
    <div class="col-3 ">
        <div class="form-group">
            <label for="delivaryTime"><?= lang('newPayable.deleveryTime') ?>: </label>
...
<div class="row">
    <div class="col-6">
        <div class="form-group">
            <label><?= lang('newPayable.sellsObservations') ?>:</label>
