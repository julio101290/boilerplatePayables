<!-- Modal Pacientes -->
<div class="modal fade" id="modalListXMLGeneratePayable" tabindex="-1" role="dialog" aria-labelledby="modalListXML"
     aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <table id="table-listXMLGeneratePayable" class="table table-striped table-hover va-middle listXMLGeneratePayable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Fecha</th>
...
<script>
    ...
    var listXMLGeneratePayable = $('#table-listXMLGeneratePayable').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        autoWidth: false,
                ...
                "data": function (data) {
                    return `<td class="text-right py-0 align-middle">
                            <div class="btn-group btn-group-sm">
                                <button class="btn-success btn-makePayableFromXML" RFCReceptor="${data.rfcReceptor}" data-id="${data.uuidTimbre}" ><i class="fas fa-plus-circle"></i></button>
                            </div>
                            </td>`
                }
            }
    ...
    $("#table-listXML").on("click", ".btn-addXMLPayable", function () {
    ...
    // Asegúrate de usar el ID correcto del modal
