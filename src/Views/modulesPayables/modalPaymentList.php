                                    ...
                                    <select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="hidden" name="uuidPayablePayment" id="uuidPayablePayment" class="form-control <?= session('error.uuidPayablePayment') ? 'is-invalid' : '' ?>" value="0.00" placeholder="uuidPayablePayment" autocomplete="off">
                                        ...
                                        <script>
                                            ...
                                            function savePayment() {
                                                ...
                                                var UUID = $("#uuidPayablePayment").val();
                                                var pago = $("#pago").val();
