    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?= lang('newPayable.totalForPayment') ?></h5>
            ...
            <div class="modal-body">
                <form id="form-paciente" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label"><?= lang('newPayable.datePayment') ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label"><?= lang('newPayable.methodPayment') ?></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                ...
                                <select  name="metodoPago" id="metodoPago" class="form-control <?= session('error.uuidMail') ? 'is-invalid' : '' ?>" value="" placeholder="UUID Registro" autocomplete="off">
                                    <option value="1"> <?= lang('newPayable.methodPaymentCash') ?></option>
                                    <option value="2"> <?= lang('newPayable.creditCard') ?></option>
                                    <option value="3">  <?= lang('newPayable.transfer') ?></option>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label"><?= lang('newPayable.payment') ?></label>
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="form-group row">
                                            <label for="tireType" class="col-sm-2 col-form-label"><?= lang('newPayable.change') ?></label>
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="form-group row">
                                            <label for="tireType" class="col-sm-2 col-form-label"><?= lang('newPayable.paymentObservations') ?></label>
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"><?= lang('newPayable.closePayment') ?></button>
                                            <button type="button" class="btn btn-primary btn-sm btnSavePayment" id="btnSavePayment"><?= lang('newPayable.savePayment') ?></button>
                                        </div>
                                        </div>
                                        </div>
                                        </div>
